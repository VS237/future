...
DATABASE_URL = "mysql://mzcSGh9QiCm3dgy.root:0yeaS7HIudfvLJWN@gateway01.eu-central-1.prod.aws.tidbcloud.com:4000/future"
...
# The directory where you keep your CSS/JS/Images during development
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]

# The folder where Django will move everything for production (Render will look here)
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Enable WhiteNoise to serve these files
